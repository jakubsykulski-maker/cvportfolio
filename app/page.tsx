    ...
    <main className="mx-auto max-w-5xl px-6 py-12 md:px-10 md:py-20">
      ...
      <Section eyebrow="Selected work" title="Case studies">
        <ul className="grid grid-cols-1 gap-5 md:grid-cols-2">
          ...
          {/* Placeholder slot signals "more coming" without faking
              content. Spans the row when sitting alone below two real
              cards so the grid stays balanced. */}
          <li
            aria-hidden
            className="hidden flex-col items-center justify-center rounded-3xl border border-dashed border-stone-300/80 p-7 text-center text-sm text-stone-400 md:flex md:col-span-2"
          >
            More case studies coming — meeting-notes triage, policy-document compliance, and a sharper take on personal finance reporting.
          </li>
        </ul>
      </Section>
